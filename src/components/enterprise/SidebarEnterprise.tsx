...
export default function SidebarEnterprise() {
    ...
    const links = [
        { name: "Dashboard", to: "/enterprise", icon: <LayoutDashboard className="w-4 h-4" /> },
        { name: "Cargos", to: "/enterprise/cargos", icon: <Briefcase className="w-4 h-4" /> },
        { name: "Candidatos", to: "/enterprise/candidatos", icon: <Users className="w-4 h-4" /> },
        { name: "Perfil", to: "/enterprise/perfil", icon: <User className="w-4 h-4" /> },
    ];
